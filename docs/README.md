...
Note:- This is the repository for the documentation of BhashaX. If you want to contribute to the code itself, please contact the owner of repo.
...
```
{
    "AUTHOR": "Community",
    "VERSION": "1.0",
    "LANG": {"" : "EN"}, // ISO Language code for the language
    "LANGUAGE": {"" : "ENGLISH"}, // Full name of language
    "CT":".js", //Ignore
    "EXTENSION":".",
    "SPECIAL_SYMBOLS":"+-*/% = &|^>< .",
    "NUMBERS": {"" : "1234567890"},
