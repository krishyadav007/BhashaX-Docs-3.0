...
```
$संख्या1 = पूर्णांक(डाल("कृपया संख्या1 बताएं"));
$संख्या2 = पूर्णांक(डाल("कृपया संख्या2 बताएं"));

$संख्या3 = $संख्या1 + $संख्या2;

दिखाए("संख्या3 का मूल्य है : ");
दिखाए($संख्या3);
```
## 4. How to build a Simple Interest Calculator 
```
$मूलधन = पूर्णांक(डाल("कृपया मूलधन बताएं"));
$समय = पूर्णांक(डाल("कृपया समय बताएं"));
$ब्याजदर = पूर्णांक(डाल("कृपया ब्याज दर बताएं"));

$मिश्रधन = ($मूलधन * $समय * $ब्याजदर) / १००;
दिखाए("मिश्रधन का मूल्य है : ");
दिखाए($मिश्रधन);
```
...
दिखाए($संख्या3);
```
## 6. How to get quotient and remainder
```
$भाज्य= -७५६;
$भाजक= ८;

$भागफल = पूर्णांक($भाज्य / $भाजक);
$शेषफल = $भाज्य % $भाजक;
...
दिखाए("अदला-बदली करने से पहले");
दिखाए("संख्या1 का मूल्य है : ");
दिखाए($संख्या1);
दिखाए("संख्या2 का मूल्य है : ");
दिखाए($संख्या2);
...
```
$वर्णमाला1 = डाल("कृपया वर्णमाला1 बताएं");
$वर्णमाला2 = डाल("कृपया संख्या2 बताएं");

दिखाए("अदला-बदली करने से पहले");
दिखाए("वर्णमाला1 का मूल्य है : ");
दिखाए($वर्णमाला1);
दिखाए("वर्णमाला2 का मूल्य है : ");
दिखाए($वर्णमाला2);
...
```
$पाई = ३.१४२;
$त्रिज्या = पूर्णांक(डाल("कृपया वृत्त की त्रिज्या बताएं"));
$क्षेत्र = ($त्रिज्या * $त्रिज्या ) * $पाई;

दिखाए("वृत्त का क्षेत्र");
दिखाए($क्षेत्र);
```
## 15. How to calculate Area of a Rectangle
```
$लम्बाई = (+(डाल("कृपया आयत की लम्बाई बताएं")));  
$चौड़ाई = (+(डाल("कृपया आयत की चौड़ाई बताएं")));

$क्षेत्रफल = ($लम्बाई * $चौड़ाई );

दिखाए("आयत का क्षेत्रफल");
दिखाए($क्षेत्रफल);
```
## 16. How to calculate Area of Square
```
$विकर्ण = (+(डाल("कृपया वर्ग की विकर्ण बताएं")));  

$क्षेत्रफल = ($विकर्ण ** २ );

दिखाए("वर्ग का क्षेत्रफल");
दिखाए($क्षेत्रफल);
```
## 17. How to calculate Area of a Triangle
```
$लंबवत = (+(डाल("कृपया त्रिभुज की लंबवत बताएं")));
$आधार = (+(डाल("कृपया त्रिभुज की आधार बताएं")));

$क्षेत्रफल = (($लंबवत * $आधार) * १/२ );

दिखाए("त्रिभुज का क्षेत्रफल");
दिखाए($क्षेत्रफल);
```
...
## 26. Binary search
```
कृत्य द्विआधारी ($सरणी, $कम, $उच्च, $तत्व){
	अगर($उच्च >= $कम) {
		...
		अन्य अगर ($सरणी[$मध्य] > $तत्व) {
			वापसी(द्विआधारी ($सरणी, $कम, $मध्य - १, $तत्व));
		}

		अन्य {
			वापसी(द्विआधारी ($सरणी, $मध्य + १, $उच्च, $तत्व));
		}
	}
	अन्य {
		वापसी(-१);
...
$परिणाम = द्विआधारी ($सरणी, ०, $सरणी.लंबाई - १, $तत्व);

अगर ($परिणाम != -१) {
	दिखाए("तत्व सूचकांक " + $परिणाम + " में मौजूद है");
}
अन्य{
	दिखाए("तत्व सरणी में मौजूद नहीं है");
}
```
## 27. How to detect Even and Odd numbers 
```
$संख्या1 = डाल("कृपया संख्या1 बताएं");

अगर ($संख्या1 % २ == ०) {
  दिखाए("यह एक सम संख्या है");
} अन्य {
  दिखाए("यह एक विषम संख्या है");
}
```
## OOPS
```
रखो $व्यक्ति = {
    ...
    $उपनाम : "यादव",
    $पूरानाम : कृत्य() {
      वापसी(यह.$प्रथमनाम + " " + यह.$उपनाम);
    }
};

दिखाए($व्यक्ति.$प्रथमनाम);
```
## OOPS 2
```
कृत्य व्यक्ति () {
...
रखो $व्यक्ति1 = नया व्यक्ति();
रखो $व्यक्ति2 = नया व्यक्ति();

$व्यक्ति1.$लिंग = "पुरुष";

$व्यक्ति1.$नमस्कार = कृत्य () {
    दिखाए('नमस्कार');
};
...
```
$संख्या1 = डाल("आप किस नंबर के लिए गुणन तालिका चाहते हैं");

दुहराओ ($संख्या2 = १; $संख्या2 <= १०; $संख्या2 ++) {
  $संख्या3 = $संख्या1 * $संख्या2;
  दिखाए($संख्या1 + " x " + $संख्या2 + " = " + $संख्या3);
}
```
## 36. How to create Fibonacci Sequence
```
$अंतिम = पूर्णांक(डाल("कितने अंक तक दिखाने हैं?"));
...
अगर ($अंतिम <= ०) {
   दिखाए("कृपया एक धनात्मक पूर्णांक दर्ज करें");
}
अन्य अगर ($अंतिम == १) {
   दिखाए("फाइबोनैचि श्रृंखला दिखा रहा है");
   दिखाए($प्रथम);
}
अन्य {
   दिखाए("फिबोनाची श्रृंखला:");
   जबतक ($संख्या < $अंतिम) {
       दिखाए($प्रथम);
       $इ = $प्रथम + $द्वितीय;
       $प्रथम = $द्वितीय;
...
```
```
## 138. How to create a Triangle without fill
```
```
